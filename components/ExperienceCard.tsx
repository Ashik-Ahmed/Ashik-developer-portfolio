...
export default function ExperienceCard({ }: Props) {
    return (
        <article className='flex flex-col rounded-lg items-center space-y-3 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] px-10 py-3 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 relative top-20'>
            <div className='flex'>
                <motion.img
                    initial={{
                        y: -100,
            ...
            <div>
                <h4 className='text-left text-3xl font-semibold underline decoration-[#F7AB0A]/50 py-3'>Key Responsibilities:</h4>
